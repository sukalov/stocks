...
export async function GET(request: Request) {
  const adjes = await db.select().from(adjustments).where(inArray(adjustments.id, [6, 9, 15, 27, 30, 33, 39, 60, 102, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123])).orderBy(adjustments.index);
