    ...
    return (
        <Table>
            ...
            {Object.keys(stocks).map((name) => (
                ...
                <TableCell>{stocks[name].meta.currency}</TableCell>
                <TableCell>{stocks[name].meta.exchange}</TableCell>
                <TableCell>{stocks[name].meta.mic_code}</TableCell>
                <TableCell>{stocks[name].values[0].datetime}</TableCell>
                <TableCell>{Math.round(stocks[name].values[0].open * 100) / 100}</TableCell>
                <TableCell>{Math.round(stocks[name].values[0].low * 100) / 100}</TableCell>
                <TableCell>{Math.round(stocks[name].values[0].high * 100) / 100}</TableCell>
                <TableCell>{Math.round(stocks[name].values[0].close * 100) / 100}</TableCell>
                </TableRow>
            ))}
            </TableBody>
        </Table>
