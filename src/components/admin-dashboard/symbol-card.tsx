  ...
  return (
    ...
    >
      <CardContent className="px-3 pt-3 pb-3 text-left whitespace-pre-wrap flex justify-start w-full items-baseline">
        ...
        <span className=" text-sm pr-2 text-primary/50 w-4">{index + 1}.</span>
        <span className="font-bold ml-4 mr-2 w-28 bg-blu">{task.symbol}</span>
        <span className="">{task.market_cap}</span>
      </CardContent>
    </Card>
  );
}
